                    ...
                    <div class="checkout__wrapper">
                        ...
                        <div class="product_checkout">
                            ...
                            <div class="cart-container checkout-container">
                           		<%
                           			CartService checkout = (CartService) session.getAttribute("cart");
                    				if(checkout != null) {
                    					for(CartModel cart : checkout.listCart){    
                                ...
                                <div class="container-product-cart container-product-checkout">
                                    <div class="product-cart product-checkout">
                                        <img src="<%=cart.getAnh() %>" alt="">
                                        <span><%=cart.getTensach() %></span>
                                    ...
                                    <div class="product-sum product-sum-checkout"><%=cart.getSoluongmua() %></div>
                                    <div class="product-money product-money-checkout">
                                        <span><%=FormatCurrencyVND.formatCurrencyVND(cart.getThanhTien()) %></span>
                                    </div>
                                </div>
                               <%}} %>
                            ...
                            <div class="container-shipping-mess">
                                ...
                                <div class="shipping-mess-footer">
                                    ...
                                    <span class="mess-footer-price"><%=FormatCurrencyVND.formatCurrencyVND(checkout.totalPrice()) %></span>
                                </div>
                            </div>
                            ...
                            <div class="container-checkout-mobile">
                                <span>Thành tiền:</span>
                                <span class="sum-mobile"><%=FormatCurrencyVND.formatCurrencyVND(checkout.totalPrice()) %></span>
                            </div>
                        </div>
                        <div class="payment_checkout">
                            ...
                            <div class="payment-fee">
                                <div class="payment-fee-sum">
                                    ...
                                    <span class="fee-sum-price"><%=FormatCurrencyVND.formatCurrencyVND(checkout.totalPrice()) %></span>
                                </div>
                                ...
                                <div class="payment-fee-payment">
                                    ...
                                    <span class="fee-payment"><%=FormatCurrencyVND.formatCurrencyVND(checkout.totalPrice()) %></span>
                                </div>
                            </div>
                            <p class="policy">Nhấn "Đặt hàng" đồng nghĩa với việc bạn đồng ý tuân theo <span
                                    class="dk-policy">Điều khoản Shopee</span>
                             </p>
                            
                            <form class="payment-btn" action="./order" method="post"> 
                        ...
                        <div class="sum-pay-mobile">
                            <div class="sum-pay-mobile-left">
                                ...
                                <span class="active"><%=FormatCurrencyVND.formatCurrencyVND(checkout.totalPrice()) %></span>
                            </div>
