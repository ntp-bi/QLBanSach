...
<%@page import="ntp.model.OrderModel"%>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
							...
							%>
							                <tr>
							                    ...
							                    <td style="text-align: center;"><%=FormatCurrencyVND.formatCurrencyVND(order.getGia()) %></td>
							                    <td style="text-align: center;"><%=order.getSoLuongMua() %></td>
							                    <td style="text-align: center;"><%=FormatCurrencyVND.formatCurrencyVND(Double.parseDouble(order.getThanhtien())) %></td>
							                    <td style="text-align: center;">
							                        <a class="btn btn-sm btn-primary" href="./admin?id=<%=order.getMaChiTietHD()%>&action=delete">
							                            Xóa
							                        </a>
							                    </td>
							                    <td style="text-align: center;">
							                        <a class="btn btn-sm btn-success" href="./admin?id=<%=order.getMaChiTietHD()%>&action=accept">
							                            Xác Nhận
							                        </a>
							                    </td>
							                </tr>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="assets/img/avt.jpg" alt="" style="width: 40px; height: 40px; object-fit: cover;">
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-0">Nguyễn Tâm Phước</h6>
                                        <small>15 minutes ago</small>
                                    </div>
