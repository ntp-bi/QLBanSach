...
<%@page import="ntp.model.BookCategoryModel"%>
...
<body>
    <div class="main product-page">
        <header class="header header-mobile">
            <div class="grid wide"> <!-- kích thước width = 1200px nên nó tự động căn = kích thước 1200px  -->
                ...
                <div class="header-with-search">
                    ...
                    <div class="header__logo hide-on-tablet header__logo-page">
                    ...
                    <form action="./product" method="get" class="header__search header__search-page">
                        <a href="./home">
                            <i class="page-left-icon fa-solid fa-arrow-left"></i>
                        </a>
                        <div class="header__search-input-wrap">                         
                            <input name="txtkey" type="text" class="header__search-input header__search-input-page-mobile"
                                placeholder="Nhà sách NTP">
	        ...
	        <div class="product__heading">
	            <div class="product-heading-left">
	                <div class="product-background">
	                    <img src="./assets/img/productpage-bg2.jfif" alt="" class="bg">
	                    <div class="product-personal-shop">
	                        <img src="./assets/img/avt.jpg" alt="" class="product-personal">
	                        <p class="product-personal-name">Nhà Sách Ntp</p>
	                        <span class="onl">Online 12 phút trước</span>
	                        <button class="product-personal-btn">
	                            <i class="fa-solid fa-plus"></i>
	                            <span>Theo dõi</span>
	                        </button>
	                        <button class="product-personal-btn-mobile">                
	                            <span>Theo dõi</span>
	                        </button>
	                    </div>
	                </div>
	            </div>
	            <div class="product-heading-mid">
	                <div class="product-heading-product">
	                ...
	                <div class="product-heading-product">
	                    ...
	                    <span class="product-text2">Đang Theo: </span>
	                    <span class="quantity">1</span>
	                </div>
	                <div class="product-heading-product">
	                    <i class="fa-solid fa-message"></i>
	                    <span class="product-text3">Tỉ Lệ Phản Hồi Chat: </span>
	            ...
	            <div class="product-heading-right">
	                <div class="product-heading-product">
	                    ...
	                    <span class="quantity">31,2k</span>
	                </div>
	                <div class="product-heading-product">
	                    <i class="fa-solid fa-star"></i>
	                    <span class="product-text2">Đánh giá: </span>
	                    <span class="quantity">4.8</span>
	                </div>
	                <div class="product-heading-product">
	                    <i class="fa-solid fa-user-check"></i>
	                    <span class="product-text3">Tham gia: </span>
	                    <span class="quantity">2 năm trước</span>
	                </div>
	            </div>
	        </div>
	        <div class="product__heading-list">
	            <div class="list-item">
	                <span>Dạo</span>
	            </div>
	            <div class="list-item">
	            	<a href="./product">
	                	<span class="active-product">Tất cả sản phẩm</span>
	            	</a>
	            </div>
	      		<div class="list-item">
	            	<a href="#">
	                	<span>Bí quyết cuộc sống</span>
	            	</a>
	            </div>     
	            <div class="list-item">
	            	<a href="#">
	            ...
	            <div class="list-item list-item-more">
	                <span>Thêm</span>
	                <i class="fa-solid fa-caret-down"></i>
	            </div>
	        </div>
       	</div>
        <div class="product__heading-list-mobile">          
            <div class="list-item">
                <span>Shop</span>
            </div>
            <div class="list-item">
                <span class="active-product">Sản phẩm</span>
            </div>
            <div class="list-item">
                <span>Danh mục</span>
            </div>
        ...
        <div class="product__heading-list-mobile-sub">
            <div class="sub-mobile-list-item sub-mobile-list-item--separate">
                <span class="sub-active-product">Phổ biến</span>
            </div>
            <div class="sub-mobile-list-item sub-mobile-list-item--separate">
                <span class="dot">Mới nhất</span>
                <span class="dot-active"></span>
            </div>
            <div class="sub-mobile-list-item sub-mobile-list-item--separate">
                <span>Bán chạy</span>
            </div>
            <div class="sub-mobile-list-item">
                <span>Giá</span>              
                ...
                <div class="row sm-gutter main__content">
                    <div class="col l-2 m-0 c-0">
                        <nav class="category">
							...
							<%
								List<BookCategoryModel> dsloai = (List<BookCategoryModel>) request.getAttribute("listBookCategory");
								for(BookCategoryModel bookCategory : dsloai){
							%>
                                <li class="category-item">
                                    <a href="./product?maloai=<%=bookCategory.getMaloai() %>" class="category-item__link">
                                    	<%= bookCategory.getTenloai()%>
                                    </a>
                            <%} %>
                                </li>                               
                            </ul>
                    ...
                    <div class="col l-10 m-12 c-12">
                        <div class="home-filter hide-on-mobile-tablet">
                            <span class="home-filter__labler">Sắp xếp theo</span>
                            ...
                            <div class="select-input">
							    ...
							    <ul class="select-input__list">
							        <li class="select-input__item">
							            <a href="?sort=asc&page=<%=currentPage%>" class="select-input__link">Giá: Thấp đến cao</a>
							        </li>
							        <li class="select-input__item">
							            <a href="?sort=desc&page=<%=currentPage%>" class="select-input__link">Giá: Cao đến thấp</a>
							        </li>
							    </ul>
							</div>
                            ...
                            <div class="home-filter__page">
                                ...
                                <div class="home-filter__page-control">
                                    <a href="?page=<%= currentPage - 1 %>" 
                                    	class="home-filter__page-btn <%= currentPage == 1 ? "home-filter__page-btn--disabled" : ""%>">
                                        <i class="home-filter__page-icon fa-solid fa-chevron-left"></i>
                                    </a>
                                    <a href="?page=<%= currentPage + 1 %>" 
                                    	class="home-filter__page-btn <%= currentPage == totalPages ? "home-filter__page-btn--disabled" : ""%>">
                        ...
                        <div class="home-product">
                            <div class="row sm-gutter">
                           		<%
                           			List<BookModel> ds = (List<BookModel>) request.getAttribute("listBook");
                           			for(int i = 0; i < ds.size(); i++) {
                           				BookModel book = ds.get(i);
                           				
		                           		double gia = book.getGia();
		                           	    String formattedAmount = FormatCurrencyVND.formatCurrencyVND(gia);
                           		%>
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home-product-item" href="./product-detail?id=<%= book.getMasach()%>">
                                        <div class="home-product-item__img"
                                          style="background-image: url('<%= book.getAnh() %>')">                                     
                                        </div>
                                        <h4 class="home-product-item__name"><%=book.getTensach() %></h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-old">200.000đ</span>
                                            <span class="home-product-item__price-current"><%= formattedAmount %></span>
                                        </div>
                                        ...
                                        <div class="home-product-item__origin">
                                            <span class="home-product-item__origin-brand">Qthouse</span>
                    ...
                    <ul class="pagination home-product__pagination">
				        <li class="pagination-item">
				            <a href="?page=<%= currentPage - 1 %>" 
				            	class="pagination-item__link <%= currentPage == 1 ? "disabled" : "" %>"
				            >
				        ...
				        <li class="pagination-item">
				            <a href="?page=<%= currentPage + 1 %>" 
				            	class="pagination-item__link <%= currentPage == totalPages ? "disabled" : "" %>"
				            >
	...
	<footer class="footer footer-page-mobile">
    ...
    <script src="./productBgswiper.js"></script>
</body>
