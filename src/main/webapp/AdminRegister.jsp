                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="./adminRegister" method="post">
	                        <div class="form-floating mb-3">
	                            <input type="text" name="email" class="form-control" id="floatingText" placeholder="Email/Số diện thoại/Tên đăng nhập">
                        ...
                        <p class="text-center mb-0">Bạn đã có tài khoản? <a href="./adminLogin">Đăng nhập</a></p>
                    </div>
                </div>
            </div>
        </div>
