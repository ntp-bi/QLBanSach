...
<%@page import="ntp.model.HistoryModel"%>
...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/historyPurchase.css">
...
<body>
    <div class="main product-page">
        <header class="header header-mobile header-mobile-history">
            <div class="grid wide"> <!-- kích thước width = 1200px nên nó tự động căn = kích thước 1200px  -->
                ...
                <div class="header-with-search">
                    ...
                    <input type="checkbox" hidden id="mobile-search-checkbox" class="header__search-checkbox">
                     ...
                     <form action="./historyController" method="post"  class="header__search header__search-page">
                        <a href="./homeController">
                            <i class="page-left-icon fa-solid fa-arrow-left"></i>
                        </a>
                        <div class="header__search-input-wrap">                         
                            <input name="txttk" type="text" class="header__search-input header__search-input-page-mobile"
                                placeholder="Tìm kiếm sản phẩm bạn đã mua.">
                ...
                <div class="header__cart header__cart-page-mobile">
                     <div class="header__cart-wrap">
                            <a href="./cartController">
                                <i class="header__cart-icon fa-sharp fa-solid fa-cart-shopping"></i>
                            </a>
                             <%
                            	CartService cart = (CartService) request.getAttribute("cart");
                    			if(cart != null) {
                            %>                      
                                        ...
                                        <div class="header__cart-item-info">
                                            <div class="header__cart-item-head">
                                                ...
                                                <div class="header__cart-item-price-wrap">
                                                    <span class="header__cart-item-price"><%=FormatCurrencyVND.formatCurrencyVND(gh.getGia()) %></span>
         ...
         <header class="header-history-mobile">
        ...
        <div class="history-container">
            <div class="grid wide">
                <div class="row sm-gutter history-content">
                    <div class="col l-2 m-0 c-0">
                        <nav class="history-category">
                            <div class="category-heading">
                                <div class="category-heading-avt">
                                    <i class="fa-regular fa-user"></i>
                                </div>
                                <div class="category-heading-info">
                                    <span class="name"><%=kh.getHoten() %></span>
                                    <div class="change">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-list-item">
                                    <a href="">
                                        ...
                                        <span class="active">Đơn mua</span>
                                    </a>
                                </li>
                                <li class="category-list-item">
                                    <a href="">
                    ...
                    <div class="col l-10 m-12 c-12">
						...
						%>
                        <div class="history-list-product-box">
                            <div class="history-list-product">
                                <ul class="list-product-heading">
                                    <li class="list-product-heading-list">
                                        <span class="name-brand">Nhà sách NTP</span>
                                        <button class="btn-chat">
                                            <i class="fa-regular fa-message"></i>
                                            <span>Chat</span>
                                        </button>
                                        <a href="./productPageController" class="view-shop">
                                    ...
                                    <li class="list-product-heading-list">
                                        ...
                                        <span class="complete">Đơn hàng đã được giao thành công</span>
                                        <i class="fa-regular fa-circle-question"></i>
                                    </li>
                                     <li class="list-product-heading-list-mobile">
                                        <i class="fa-solid fa-truck"></i>
                                        <span class="complete">Giao thành công</span>                                       
                                    </li>
                                </ul>
                                <div class="list-product-item">
                                    <div class="product-item-img">
                                        <img src="<%=history.getAnh() %>" alt="">
                                    </div>
                                    <div class="product-item-content">
                                        <span class="name"><%=history.getTensach() %></span>
                                        <span class="classify">Phân loại: sách</span>
                                        <span class="quantity">x<%=history.getSoluongmua() %></span>
                                    </div>
                                    <div class="product-item-price">
                                        <span class="product-item-price-old">439.000₫</span>
                                        <span class="product-item-price-cur"><%=FormatCurrencyVND.formatCurrencyVND(history.getGia()) %></span>
                                    </div>
                                </div>
                            </div>
                            <div class="history-list-product-checkout">
                                <div class="checkout">
                                    <span>Thành tiền: </span>
                                    <span class="price"><%=FormatCurrencyVND.formatCurrencyVND(history.getThanhtien()) %></span>
                                </div>
                                <div class="button">
